...
import { CLEAR_ATTACHMENTS_EVENT, DndUploaderContext } from "@/components/WorkspaceChat/ChatContainer/DnDWrapper";
import PromptInput, { PROMPT_INPUT_EVENT } from "@/components/WorkspaceChat/ChatContainer/PromptInput";
...
export default function CallContainer({ workspace, knownHistory = [] }) {
